...
<body>
  ...
  <div class="content">
    <header class="header reveal" style="animation-delay:.1s"><nav class="nav"><a href="#projects">Works</a><a href="#about">About</a>${data.config.showSkills && skills.length ? '<a href="#skills">Skills</a>' : ''}<a href="#contact">Contact</a></nav><a class="logo" href="#top"><span class="logo-mark">${navMark}</span><span>${escapeHtml(data.user.username || data.user.displayName || 'AQUA.dev')}</span></a><button class="btn" type="button" data-drawer-open>Hire Me</button></header>
